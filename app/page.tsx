...
const suppliedDetailVideos: Record<string, { src: string; poster?: string; label: string }> = {
  ...
  "03": { src: "yoshini-moshini-loop.webm", label: "Yoshini and Moshini performance video" },
  "04": { src: "the-ensemble-loop.webm", label: "The Ensemble performance video" },
  "05": { src: "the-audience-loop.webm", label: "The Audience performance video" },
};
